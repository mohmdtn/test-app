    ...
    <section className="flex justify-between">
      ...
      <div>
        <div className="flex items-center">
          ...
          <div className="bg-gray-100 rounded-3xl text-base text-gray-700 px-2 flex h-6 justify-center items-center"><span className="font-iransans">120</span> حساب</div>
        </div>
